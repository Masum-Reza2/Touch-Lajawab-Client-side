...
const Router = createBrowserRouter([
    {
        ...
        children: [
            { index: true, element: <Home /> },
            {
                ...
                loader: () => fetch('https://restaurant-server-g5g2jk49t-masum-rezas-projects.vercel.app/foodCount')
            },
            ...
            { path: '/myOrderedFoods', element: <PrivateRoute><MyOrderedFoods /></PrivateRoute> },
            {
                ...
                loader: ({ params }) => fetch(`https://restaurant-server-g5g2jk49t-masum-rezas-projects.vercel.app/allFoods/${params.id}`)
            },
            {
