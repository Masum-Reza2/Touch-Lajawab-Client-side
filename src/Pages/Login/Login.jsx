...
const Login = () => {
    ...
    return (
        <div className='py-10 flex flex-col lg:flex-row items-center justify-center '>
            ...
            <div className="flex-1">
                <form onSubmit={handleLogin} className={`relative  flex w-[90vw] md:w-[60vw] lg:w-[40vw] 2xl:w-[25vw] flex-col rounded-xl ${mode ? 'bg-black text-white' : 'bg-white'} bg-clip-border text-gray-700 shadow-md shadow-black mx-auto py-5`}>
                ...
                <div className={`flex w-[90vw] md:w-[60vw] lg:w-[40vw] border flex-col rounded-xl bg-clip-border  shadow-md shadow-black mx-auto py-5 mt-5 2xl:w-[25vw] ${mode ? 'bg-black text-white' : 'bg-white text-gray-700'}`}>
