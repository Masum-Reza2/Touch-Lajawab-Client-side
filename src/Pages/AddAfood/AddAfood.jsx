...
const AddAfood = () => {
        ...
        secureAxios.post('/allFoods', newFoodItem)
            .then(result => {
                if (result.data.insertedId) {
                    Swal.fire(
                        'Added!',
                        `Food item ${foodName} added successfully!`,
                        'success'
                    )
    ...
    return (
        <>
            <div className={`w-[90%] mx-auto py-5 min-h-screen md:min-h-screen flex flex-col items-center justify-center`}>
                <h1 className="py-2 md:py-5 font-semibold">Add a food item.</h1>
